...
func Test_parse(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: []hand{
				{bet: 765, values: []int{3, 2, 10, 3, 13}, rank: Pair},
				{bet: 684, values: []int{10, 5, 5, 0, 5}, rank: FourOfKind},
				{bet: 28, values: []int{13, 13, 6, 7, 7}, rank: TwoPairs},
				{bet: 220, values: []int{13, 10, 0, 0, 10}, rank: FourOfKind},
				{bet: 483, values: []int{12, 12, 12, 0, 14}, rank: FourOfKind},
				{bet: 201, values: []int{2, 2, 5, 5, 2}, rank: FullHouse},
				{bet: 201, values: []int{6, 6, 3, 3, 6}, rank: FullHouse},
				{bet: 201, values: []int{7, 7, 3, 3, 7}, rank: FullHouse},
				{bet: 201, values: []int{8, 8, 3, 3, 8}, rank: FullHouse},
				{bet: 201, values: []int{9, 9, 4, 4, 9}, rank: FullHouse},
				{bet: 201, values: []int{0, 0, 0, 13, 13}, rank: FiveOfKind},
				{bet: 201, values: []int{0, 0, 0, 0, 0}, rank: FiveOfKind},
				{bet: 201, values: []int{0, 0, 0, 0, 2}, rank: FiveOfKind},
				{bet: 201, values: []int{0, 13, 13, 12, 12}, rank: FullHouse},
				{bet: 201, values: []int{12, 0, 0, 6, 7}, rank: ThreeOfKind},
			},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := parse(tt.args.input, tt.j); !reflect.DeepEqual(got, tt.want) {
